...
The R for Health Data Science book and the Exercise Set 1 make the subject very enjoyable, especially because it does not require one to simply read and memorise things. Following the instructions and running the program halps understand and remember the things the text describes. However, it will still take me a few repetions of this crash course to fully grasp some concepts.
